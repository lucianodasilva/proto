...
namespace vmath {
	...
	template < class value_t, template < class > class struct_t >
	inline struct_t < value_t > lerp (const struct_t < value_t > & v1, const struct_t < value_t > & v2, float alpha) {
		struct_t < value_t > v;
	...
	template < class value_t, template < class > class struct_t >
	inline void lerp (const struct_t < value_t > & v1, const struct_t < value_t > & v2, float alpha, struct_t < value_t > & r) {
		for (int i = 0; i < struct_t < value_t >::size; ++i)
